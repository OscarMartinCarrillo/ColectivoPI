    ...
    <div class="container mt-3 mx-auto p-2 w-8/11">
        <div class="container my-1 mx-auto px-4 md:px-12">
            ...
            @foreach ($activities as $item)
                <div
                    class="shadow-md hover:shadow-2xl transform hover:scale-105 grid grid-cols-1 md:grid-cols-2 container mx-auto px-4 pt-4 border-8 border-white my-4 bg-gray-200 hover:border-red-500">
                    <a href="{{ route('activities.show', $item) }}">
                        <div class="justify-items-center my-4 px-auto ml-2">
                    ...
                    <a href="{{ route('activities.show', $item) }}">
                        <div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal"
                            ...
                            <div class="font-sans">
                                ...
                                <h1
                                    class="font-bold font-sans break-normal text-gray-900 pt-6 text-3xl md:text-4xl border-b-2 border-gray-500">
                                    {{ $item->titulo }}</h1>
                            ...
                            <div class="overflow-hidden truncate w-full" style=" max-height:250px;display: inline-block;">
                                <p class="py-2">
                                    <?php echo base64_decode($item->contenido); ?>
                                </p>
                            </div>
