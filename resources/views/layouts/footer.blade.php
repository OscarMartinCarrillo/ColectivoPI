    ...
    <div class="flex flex-col">
        ...
        <div class="mt-4 md:mt-0 flex flex-col md:flex-row">
            <nav
                ...
                <a aria-current="page" href="{{route('foro.indexCategory')}}" class="hover:text-white">
                    Foro
                </a>
            </nav>
            ...
            <div class="mt-7 md:mt-0 flex-1 flex flex-col items-center justify-center md:items-start md:pl-5">
                ...
                <span class="mt-7 md:mt-1">
                    Created by
                    <a class="underline hover:text-primary-gray-20" href="https://github.com/OscarMartinCarrillo">
                        Oscar Martín
                    </a>
                </span>
            </div>
