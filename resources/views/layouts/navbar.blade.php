<nav
    ...
    <div class="container mx-auto">
        <div class="sm:flex justify-around">
            <a href="{{ route('dashboard') }}" class="ml-5">
            ...
            <ul class="text-gray-400 sm:self-center text-xl border-t sm:border-none">
                <li class="inline-block">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                        class="text-gray-700 text-base font-bold tracking-wide uppercase py-4 px-3">
                        {{ __('Inicio') }}
                    </x-nav-link>
                </li>
                <li class="inline-block">
                ...
                <li class="inline-block">
                    <x-nav-link :href="route('foro.indexCategory')" :active="request()->routeIs('categories.*')"
                        class="text-gray-700 text-base font-bold tracking-wide uppercase py-4 px-3">
                        {{ __('Foro') }}
                    </x-nav-link>
                </li>
            ...
            <div class="text-white text-3xl font-bold p-3  my-auto">
                <div class="sm:flex sm:items-center sm:ml-6">
                    <hr class="border-0 bg-red-500 text-red-500 w-px sm:h-4 mr-4">
                    @auth
