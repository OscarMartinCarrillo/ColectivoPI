...
class UserController extends Controller
{
    ...
    public function destroy(User $user)
    {
        try {
            ...
            if ($user->id==Auth::user()->id) {
                ...
                return redirect('/')->with('error',"Cuenta Deshabilitada");
            }
            return redirect()->route('perfil.todos')->with('mensaje', "Usuario Deshabilitado");
        } catch (\Exception $ex) {
            return redirect()->route('perfil.todos')->with('error', "No se ha podido deshabilitar: " . $ex->getMessage());
        }
    }
    ...
    public function habilitar(User $user){
        try {
            ...
            return redirect()->route('perfil.todos')->with('mensaje', "Usuario Habilitado");
        } catch (\Exception $ex) {
            return redirect()->route('perfil.todos')->with('error', "No se ha podido habilitar: " . $ex->getMessage());
        }
    }
}
